...
const contactInfo = [
  ...
  },
  {
    ...
    icon: <FiMail size={24} />,
    title: "Email",
    details: "talhabadar184@gmail.com",
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-4 z-10">
        {/* Header */}
        <div className="text-center mb-5 contact-element">
                ...
                <div className="relative group">
                  ...
                  <div className="relative">
                    ...
                    <label 
                      htmlFor="message"
                      className={`absolute left-12 top-4 text-gray-400 transition-all duration-300 ${
                        focusedField === 'message' || formData.message ? 'text-xs -translate-y-6 text-emerald-400' : 'text-base'
                      }`}
                    >
